  ...
  describe('Render', () => {
    it('should pass all necessary properties to the div element', () => {
      ...
      const widget = shallow(viewFunction({
        ...
        restAttributes: { restAttributes: 'restAttributes' },
      } as any));
  ...
  describe('Logic', () => {
    describe('Getters', () => {
      describe('attributes', () => {
        it('should return ARIA labels', () => {
          ...
          expect(widget.attributes).toEqual({
            'aria-hidden': 'true', id: '10', role: 'button', 'aria-level': '100',
          });
        });

        it('should return elementAttrs without className', () => {
          const widget = new Widget({ elementAttr: { class: 'custom-class', htmlAttr: 'htmlAttr' }, visible: true });
        ...
        it('should not return accessKey if widget is not focusable', () => {
          ...
          expect(widget1.attributes).toEqual({});
        });
        ...
        it('should return accessKey if widget is focusable', () => {
          ...
          expect(widget2.attributes).toEqual({ accessKey: 'c' });
        });
        ...
        it('should not return accessKay if widget is disabled', () => {
          ...
          expect(widget3.attributes).toEqual({ 'aria-disabled': 'true' });
        });
      });

      describe('styles', () => {
        it('should spread style', () => {
          const widget = new Widget({ style: { color: 'red' } });
      ...
      describe('cssClasses', () => {
        ...
        it('should add elementAttr class', () => {
          const widget = new Widget({ visible: true, elementAttr: { class: 'class-from-elementAttr' } });

          expect(widget.cssClasses).toEqual('dx-widget class-from-elementAttr');
        });
      });
